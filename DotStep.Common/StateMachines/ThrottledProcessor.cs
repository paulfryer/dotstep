...
namespace DotStep.Common.StateMachines
{
    public class ThrottledProcessor : StateMachine<ThrottledProcessor.EnsureAccountAndRegionAreSet>
    {
        ...
        {
            [Required] public string StateMachineName { get; set; }

            public int RunningExecutionsCount { get; set; }
            public string AccountId { get; set; }
            public string RegionCode { get; set; }

            [Required] public string MessageProcessorType { get; set; }

            [Required] public string MessageProcessorName { get; set; }

            public int MessagesWaitingForProcessing { get; set; }
            public int MessagesProcessing { get; set; }

            [Required] public string JobQueueName { get; set; }

            [Required] public int JobProcessingParallelSize { get; set; }
        ...
        public class
            EnsureAccountAndRegionAreSet : ReferencedTaskState<Context, Initialize,
                EnsureAccountAndRegionAreSet<Context>>
        {
        }
        ...
        public class DetermineProcessingBehavior : ChoiceState<Done>
        {
            public override List<Choice> Choices => new List<Choice>
            {
                new Choice<Done, Context>(c => c.NoMessagesProcessingOrWaiting),
